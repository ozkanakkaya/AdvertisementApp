...
namespace Ozkky.AdvertisementApp.Business.Services
{
        ...
        where T : BaseEntity
    {
        ...
        private readonly IValidator<CreateDto> _crateDtoValidator;
        private readonly IValidator<UpdateDto> _updateDtoValidator;
        private readonly IUow _uow;

        public Service(IMapper mapper, IValidator<CreateDto> crateDtoValidator, IValidator<UpdateDto> updateDtoValidator, IUow uow)
        {
            _mapper = mapper;
            _crateDtoValidator = crateDtoValidator;
        ...
        {
            var result = _crateDtoValidator.Validate(dto);
            if (result.IsValid)
            {
